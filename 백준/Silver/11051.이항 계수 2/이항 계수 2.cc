...
using namespace std;
ll fac[1001], n, k, inv[1001];//inv[x]의 정의는 x의inverse가 아닌 x!의 inverse
...
int main() {
    ...
    inv[1000] = power(fac[1000], P - 2);    //페르마의 소정리를 이용하여 fac(400만)의 inverse를 구함(이때 분할 정복을 이용하여 logP의 시간에 처리) 
